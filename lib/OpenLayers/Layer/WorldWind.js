...
* @class
*/
OpenLayers.Layer.WorldWind = function(name, url, lzd, zoomLevels, params) {
    this.initialize(name, url, lzd, zoomLevels, params);
}
OpenLayers.Layer.WorldWind.prototype = MochiKit.Base.merge(
