...
* @class
*/
OpenLayers.Layer.KaMap = function(name, url, params, units, resolution) {
    this.initialize(name, url, params, units, resolution);
}
OpenLayers.Layer.KaMap.prototype = MochiKit.Base.merge(
