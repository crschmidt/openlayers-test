...
* @class
*/
OpenLayers.Popup.AnchoredBubble = function(id, lonlat, size, contentHTML, anchor) {
    this.initialize(id, lonlat, size, contentHTML, anchor);
}
//Border space for the rico corners
OpenLayers.Popup.AnchoredBubble.CORNER_SIZE = 5;

OpenLayers.Popup.AnchoredBubble.prototype = MochiKit.Base.merge(
