...
if (typeof(MochiKit) == 'undefined') { 
    ...
    if (typeof(MochiKit.Base) == 'undefined') {
        throw 'OpenLayers.Util depends on MochiKit.Base!';
    }
    if (typeof(MochiKit.Style) == 'undefined') {
        throw 'OpenLayers.Util depends on MochiKit.Style!';
    }
}
if (typeof(OpenLayers.Util) == 'undefined') {
    OpenLayers.Util = {};
}
...
OpenLayers.Bounds = function(left, bottom, right, top) {
    this.initialize(left, bottom, right, top);
};
