...
OpenLayers.Control.PanZoom.prototype = MochiKit.Base.merge(
    ...
    */
    ...
    _addButton:function(id, img, xy, sz) {
        ...
        connect( btn, "onmousedown", this, this.buttonDown );
        connect( btn, "ondblclick", this, this.doubleClick );
        connect( btn, "onclick", this, this.doubleClick );
        btn.action = id;
        btn.map = this.map;
